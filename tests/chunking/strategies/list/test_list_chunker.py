# tests/chunking/strategies/test_layout_list.py

import logging
import os

# Make sure the 'src' directory is in the Python path
# You can also achieve this with pytest configuration (e.g., in pyproject.toml)
import sys
...
def test_chunk_with_valid_list_items(list_chunking_strategy, document_metadata):
    ...
    """
    # ARRANGE: Create a mock LAYOUT_LIST with two valid list items
    ...
    # Verify the factory method was called correctly for the first item
    ...
    # Verify the factory method was called correctly for the second item
...
def test_chunk_with_empty_children_list(list_chunking_strategy, document_metadata):
    ...
    """
    # ARRANGE: Create a mock list block with an empty children list
...
def test_chunk_skips_children_with_empty_text(list_chunking_strategy, document_metadata):
    ...
    """
    # ARRANGE: Create children with valid, empty, and whitespace text
    ...
    # Check that chunk index was correctly incremented from the start value
