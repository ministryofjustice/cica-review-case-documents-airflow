...
```bash
LAYOUT_CHUNKING_MAXIMUM_CHUNK_SIZE=80
LAYOUT_CHUNKING_Y_TOLERANCE_RATIO=0.5
MAX_VERTICAL_GAP=0.5
LAYOUT_CHUNKING_LAYOUT_CHUNKING_LINE_CHUNK_CHAR_LIMIT=300
```
...
from ingestion_pipeline.chunking.strategies.layout.strategies.line_sentence_chunker import LineSentenceChunkingConfig
```
