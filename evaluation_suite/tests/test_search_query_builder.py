...
def test_create_hybrid_query_with_dates(mock_extract_dates, mock_settings):
    ...
    query = search_query_builder.create_hybrid_query("12/05/2021", model_id="stub-model-id", result_size=5)
...
def test_create_hybrid_query_no_dates(mock_extract_dates, mock_settings):
    ...
    query = search_query_builder.create_hybrid_query("fracture", model_id="stub-model-id", result_size=5)
...
def test_create_hybrid_query_date_detection_disabled(mock_extract_dates, mock_settings):
    ...
    search_query_builder.create_hybrid_query("12/05/2021", model_id="stub-model-id", result_size=5)
