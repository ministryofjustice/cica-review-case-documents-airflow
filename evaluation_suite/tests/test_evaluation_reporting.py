...
from evaluation_suite.search_evaluation.relevance import evaluation_reporting
...
def _make_summary(**overrides) -> EvaluationSummary:
    defaults = dict(
        ...
        avg_precision_at_10=1.0,
        avg_precision_at_20=1.0,
        avg_recall_at_10=1.0,
        avg_recall_at_20=1.0,
        avg_f1_at_10=1.0,
        avg_f1_at_20=1.0,
        avg_term_based_precision_at_10=100.0,
        avg_term_based_precision_at_20=100.0,
        avg_acceptable_term_based_precision_at_10=100.0,
        avg_acceptable_term_based_precision_at_20=100.0,
    ...
    return pd.DataFrame(
        {
            ...
            "recall_at_20": [1.0],
            "missing_chunk_ids": [""],
            "term_based_precision_at_10": [100],
            "acceptable_term_based_precision_at_10": [100],
            "term_based_precision_at_20": [100],
            "acceptable_term_based_precision_at_20": [100],
...
@patch("evaluation_suite.search_evaluation.relevance.evaluation_reporting.EVALUATION_LOG_FILE")
def test_append_to_evaluation_log_creates_file(mock_log_file, tmp_path):
    ...
    with patch("evaluation_suite.search_evaluation.relevance.evaluation_reporting.EVALUATION_LOG_FILE", log_path):
